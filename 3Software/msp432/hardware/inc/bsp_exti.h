...
#define motor_One_A_PIN         GPIO_PIN1
...
#define motor_Four_A_Value        BITBAND_PERI(P4IN, 2)
#define motor_Four_B_Value        BITBAND_PERI(P4IN, 3)
